...
--
-- Hôte : 127.0.0.1
-- Généré le : sam. 17 déc. 2022 à 14:39
...
(1, 'Khalil', 'Tizaoui', 'khalil', 'khalil1', 'eleve'),
(2, 'dada', 'dada', 'dada', 'dada', 'admin'),
(3, 'Antipasta', 'Amadeus', 'antipasta', 'amadeus', 'eleve'),
(4, 'Ambrosi', 'Pierre', 'ambrosi', 'pierre', 'moniteur');
