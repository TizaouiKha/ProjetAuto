 ...
 * @author Rosca
 */
public class FrmMoniteurVisualiserToutesLesLecons extends javax.swing.JFrame {

    /**
     * Creates new form FrmMoniteurVisualiserToutesLesLecons
     */
    public FrmMoniteurVisualiserToutesLesLecons() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMoniteurVisualiserToutesLesLecons.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMoniteurVisualiserToutesLesLecons().setVisible(true);
            }
        });
    }
