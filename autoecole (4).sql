...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 24 mars 2023 à 20:54
...
(113, 'Antipastar', 'Amadeus', 0, '2023-03-04', 'corvisart', '75013', 'Paris 3', '0123242526'),
...
(158, 'Tizaoui', 'Khalil', 1, '2002-08-05', '80, rue gramme', '92270', 'Bois-Colombes', '0783838391');
...
(8, '2016-08-23', '10:00:00', 11, 22, '123 AB 23', 1),
...
(67, '2016-08-10', '10:00:00', 11, 132, '123 AB 23', 1),
(68, '2016-03-25', '10:00:00', 14, 8, '234 BC 21', 1),
(69, '2016-07-14', '10:00:00', 15, 16, '345 CD 21', 1),
(73, '2016-03-27', '10:00:00', 15, 8, '123 AB 23', 1),
(74, '2016-02-19', '10:00:00', 15, 8, '123 AB 23', 1),
(75, '2016-07-29', '10:00:00', 11, 8, '123 AB 23', 1),
...
(134, '2023-03-15', '10', 8, 8, '123 AB 23', 1),
(137, '2023-03-15', '10', 8, 158, '123 AB 23', 1),
(138, '2023-03-31', '11', 11, 113, '567 EF 21', 1),
(139, '2023-03-31', '11', 11, 113, '567 EF 21', 1),
(140, '2023-03-31', '11', 11, 113, '567 EF 21', 1),
(141, '2023-03-31', '11', 11, 113, '567 EF 21', 1),
(142, '2023-03-31', '11', 11, 113, '567 EF 21', 1),
(143, '2023-03-31', '11', 11, 113, '567 EF 21', 1),
(144, '2023-03-31', '11', 11, 113, '567 EF 21', 1),
(145, '2023-03-31', '11', 11, 113, '567 EF 21', 1),
(146, '2023-03-31', '11', 11, 113, '567 EF 21', 1),
(147, '2023-03-31', '11', 11, 113, '567 EF 21', 1),
(148, '2023-03-31', '11', 11, 113, '567 EF 21', 1),
(149, '2023-03-31', '11', 11, 113, '567 EF 21', 1),
(150, '2023-03-31', '11', 11, 113, '567 EF 21', 1),
(151, '2023-03-31', '11', 11, 113, '567 EF 21', 1),
(152, '2023-03-24', '', 11, 113, '123 AB 23', 1),
(153, '2023-03-24', '', 11, 113, '123 AB 23', 1),
(154, '2023-03-24', '', 11, 113, '123 AB 23', 1),
(155, '2023-03-24', '', 11, 113, '123 AB 23', 1),
(156, '2023-03-24', '', 11, 113, '123 AB 23', 1),
(157, '2023-03-24', '12', 11, 113, '123 AB 23', 1);
...
(9, 'Tizaoui', 'Khalil', 2, '2002-08-05', '80, rue gramme', '92270', 'Bois-Colombes', '0783838391'),
(11, 'Ambrosi', 'Pierre', 0, '2006-01-06', '23, rue du Lycée', '75019', 'Paris 13', '0180234567'),
...
(20, 'Tizaoui', 'Khalil', 2, '2002-08-03', '80, rue gramme', '92270', 'Bois-Colombes', '0783838391'),
(21, 'Mammode', 'Khalim', 2, '2023-03-05', 'test', '10000', 'test', '0707');
...
INSERT INTO `users` (`idUser`, `nomUser`, `prenomUser`, `loginUser`, `pwdUser`, `statutUSer`, `CodeEleve`, `CodeMoniteur`) VALUES
(1, 'Khalil', 'Tizaoui', 'khalil', 'khalil1', 'eleve', 158, NULL),
(2, 'dada', 'dada', 'dada', 'dada', 'admin', NULL, NULL),
(3, 'Antipasta', 'Amadeus', 'Antipasta', 'Amadeus', 'eleve', 113, NULL),
(4, 'Ambrosi', 'Pierre', 'ambrosi', 'pierre', 'moniteur', NULL, 11);
...
('123 AB 23', 'Mercedes', 'Classe c', 2008, 1),
...
--
ALTER TABLE `licence`
  MODIFY `CodeLicence` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT pour la table `moniteur`
--
ALTER TABLE `moniteur`
  MODIFY `CodeMoniteur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `lecon`
  ADD CONSTRAINT `lecon_ibfk_1` FOREIGN KEY (`CodeMoniteur`) REFERENCES `moniteur` (`CodeMoniteur`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `lecon_ibfk_2` FOREIGN KEY (`CodeEleve`) REFERENCES `eleve` (`CodeEleve`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `lecon_ibfk_3` FOREIGN KEY (`Immatriculation`) REFERENCES `vehicule` (`Immatriculation`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `licence`
--
ALTER TABLE `licence`
  ADD CONSTRAINT `licence_ibfk_1` FOREIGN KEY (`CodeMoniteur`) REFERENCES `moniteur` (`CodeMoniteur`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `licence_ibfk_2` FOREIGN KEY (`CodeCategorie`) REFERENCES `categorie` (`CodeCategorie`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`CodeEleve`) REFERENCES `eleve` (`CodeEleve`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `users_ibfk_2` FOREIGN KEY (`CodeMoniteur`) REFERENCES `moniteur` (`CodeMoniteur`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `vehicule`
--
ALTER TABLE `vehicule`
  ADD CONSTRAINT `vehicule_ibfk_1` FOREIGN KEY (`CodeCategorie`) REFERENCES `categorie` (`CodeCategorie`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
